...
-- ==========================================
-- TABLES C0R3 / 3D SPACES (Les Conteneurs)
-- ==========================================
...
CREATE TABLE IF NOT EXISTS user_3d_spaces (
    ...
    f3rry_id INT NULL, -- Pourra lier vers une future table f3rrys
    config_json JSON, -- Stocke la position globale du conteneur
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES lands(id) ON DELETE CASCADE
);
...
CREATE TABLE IF NOT EXISTS user_media (
    ...
    placement_json JSON, -- Stocke [x, y, z] et [rx, ry, rz] à l'intérieur du conteneur
    created_at DATETIME DEFAULT CURRENT_TIMESTAMP,
    FOREIGN KEY (user_id) REFERENCES lands(id) ON DELETE CASCADE,
