...
profile_files() {
		case "$1" in
			...
			aza)
				...
				;;
			full-web)
				printf '%s\n' index.php 404.php robots.php sitemap.php land.php aza.php config.php main.js public-shell.js styles.css manifest.php manifest.json site-sw.js favicon.svg apple-touch-icon.png icons/icon.svg icons/icon-mask.svg icons/icon-192.png icons/icon-512.png icons/icon-mask-192.png icons/icon-mask-512.png
				;;
		*)
