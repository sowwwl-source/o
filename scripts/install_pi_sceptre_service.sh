...
service_name="sowwwl-pi-sceptre"
...
usage() {
	cat <<'EOF'
Usage:
  sudo bash scripts/install_pi_sceptre_service.sh [options]
...
append_group_if_present "$run_user" i2c
append_group_if_present "$run_user" input
